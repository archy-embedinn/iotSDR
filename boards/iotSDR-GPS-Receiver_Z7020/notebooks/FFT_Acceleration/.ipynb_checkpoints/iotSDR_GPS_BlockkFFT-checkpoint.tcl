...
# module references:
# ledBlink, max2769_interface, tx_stream_mux
...
# Hierarchical cell: FFT_Accelerator
proc create_hier_cell_FFT_Accelerator { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_FFT_Accelerator() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: axi_dma_fft_data, and set properties
  set axi_dma_fft_data [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 axi_dma_fft_data ]
  set_property -dict [ list \
   CONFIG.c_include_s2mm {1} \
   CONFIG.c_include_sg {0} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins S_AXI_LITE1] [get_bd_intf_pins axi_dma_fft_data/S_AXI_LITE]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins M_AXI_MM2S1] [get_bd_intf_pins axi_dma_fft_data/M_AXI_MM2S]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins M_AXI_S2MM] [get_bd_intf_pins axi_dma_fft_data/M_AXI_S2MM]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_config/M_AXIS_MM2S] [get_bd_intf_pins xfft_0/S_AXIS_CONFIG]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_MM2S [get_bd_intf_pins M_AXI_MM2S] [get_bd_intf_pins axi_dma_config/M_AXI_MM2S]
  connect_bd_intf_net -intf_net axi_dma_fft_data_M_AXIS_MM2S [get_bd_intf_pins axi_dma_fft_data/M_AXIS_MM2S] [get_bd_intf_pins xfft_0/S_AXIS_DATA]
  connect_bd_intf_net -intf_net axi_smc_1_M04_AXI [get_bd_intf_pins S_AXI_LITE] [get_bd_intf_pins axi_dma_config/S_AXI_LITE]
  connect_bd_intf_net -intf_net xfft_0_M_AXIS_DATA [get_bd_intf_pins axi_dma_fft_data/S_AXIS_S2MM] [get_bd_intf_pins xfft_0/M_AXIS_DATA]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins m_axi_mm2s_aclk] [get_bd_pins axi_dma_config/m_axi_mm2s_aclk] [get_bd_pins axi_dma_config/s_axi_lite_aclk] [get_bd_pins axi_dma_fft_data/m_axi_mm2s_aclk] [get_bd_pins axi_dma_fft_data/m_axi_s2mm_aclk] [get_bd_pins axi_dma_fft_data/s_axi_lite_aclk] [get_bd_pins xfft_0/aclk]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_resetn] [get_bd_pins axi_dma_config/axi_resetn] [get_bd_pins axi_dma_fft_data/axi_resetn]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: FFT_Accelerator
  create_hier_cell_FFT_Accelerator [current_bd_instance .] FFT_Accelerator
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net FFT_Accelerator_M_AXI_MM2S1 [get_bd_intf_pins FFT_Accelerator/M_AXI_MM2S1] [get_bd_intf_pins axi_smc/S02_AXI]
  connect_bd_intf_net -intf_net FFT_Accelerator_M_AXI_S2MM [get_bd_intf_pins FFT_Accelerator/M_AXI_S2MM] [get_bd_intf_pins axi_smc/S03_AXI]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_MM2S [get_bd_intf_pins FFT_Accelerator/M_AXI_MM2S] [get_bd_intf_pins axi_smc/S01_AXI]
  ...
  connect_bd_intf_net -intf_net axi_smc_1_M04_AXI [get_bd_intf_pins FFT_Accelerator/S_AXI_LITE] [get_bd_intf_pins axi_smc_1/M04_AXI]
  connect_bd_intf_net -intf_net axi_smc_1_M05_AXI [get_bd_intf_pins FFT_Accelerator/S_AXI_LITE1] [get_bd_intf_pins axi_smc_1/M05_AXI]
  ...
  connect_bd_net -net G_CLKOUT_1 [get_bd_ports G_CLKOUT] [get_bd_pins GPS_Receiver_IQ_Streamer/G_CLKOUT] [get_bd_pins ledBlink_0/refclk]
  ...
  connect_bd_net -net ledBlink_0_led [get_bd_ports led_0] [get_bd_pins ledBlink_0/led]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins FFT_Accelerator/axi_resetn] [get_bd_pins GPS_Receiver_IQ_Streamer/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40410000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs FFT_Accelerator/axi_dma_config/S_AXI_LITE/Reg] SEG_axi_dma_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40420000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs FFT_Accelerator/axi_dma_fft_data/S_AXI_LITE/Reg] SEG_axi_dma_fft_data_Reg
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces FFT_Accelerator/axi_dma_config/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces FFT_Accelerator/axi_dma_fft_data/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces FFT_Accelerator/axi_dma_fft_data/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
