...
proc create_hier_cell_fft_data_accelerator { parentCell nameHier } {
  ...
  create_bd_pin -dir O -type intr event_frame_started_0
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets axi_stream_select_0_M00_AXIS] [get_bd_intf_pins axi_stream_select_0/M00_AXIS] [get_bd_intf_pins ila_0/SLOT_0_AXIS]
  ...
  connect_bd_net -net xfft_data_event_frame_started [get_bd_pins event_frame_started_0] [get_bd_pins xfft_data/event_frame_started]
...
proc create_hier_cell_GPS_Receiver_IQ_Streamer { parentCell nameHier } {
  ...
  # Create instance: IQ2stream_fft, and set properties
  set IQ2stream_fft [ create_bd_cell -type ip -vlnv user.org:user:IQ2stream:1.0 IQ2stream_fft ]

  # Create instance: IQ2stream_raw, and set properties
  set IQ2stream_raw [ create_bd_cell -type ip -vlnv user.org:user:IQ2stream:1.0 IQ2stream_raw ]
  ...
  # Create instance: axis_data_fifo_fft, and set properties
  set axis_data_fifo_fft [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_data_fifo_fft ]
  set_property -dict [ list \
  ...
  # Create instance: axis_data_fifo_raw, and set properties
  set axis_data_fifo_raw [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_data_fifo_raw ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net IQ2stream_0_M00_AXIS [get_bd_intf_pins IQ2stream_raw/M00_AXIS] [get_bd_intf_pins axis_data_fifo_raw/S_AXIS]
  connect_bd_intf_net -intf_net IQ2stream_fft_M00_AXIS [get_bd_intf_pins IQ2stream_fft/M00_AXIS] [get_bd_intf_pins axis_data_fifo_fft/S_AXIS]
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins S_AXI] [get_bd_intf_pins gps_ip_settings/S_AXI]
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins axis_data_fifo_raw/M_AXIS]
  connect_bd_intf_net -intf_net axis_data_fifo_fft_M_AXIS [get_bd_intf_pins M00_AXIS_IQ] [get_bd_intf_pins axis_data_fifo_fft/M_AXIS]
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_data_fifo_fft_M_AXIS] [get_bd_intf_pins M00_AXIS_IQ] [get_bd_intf_pins ila_0/SLOT_0_AXIS]

  # Create port connections
  connect_bd_net -net G_ANT_FLG_1 [get_bd_pins G_ANT_FLG] [get_bd_pins max2769_interface_0/G_ANT_FLG]
  connect_bd_net -net G_CLKOUT_1 [get_bd_pins G_CLKOUT] [get_bd_pins IQ2stream_fft/m00_axis_aclk] [get_bd_pins IQ2stream_raw/m00_axis_aclk] [get_bd_pins axis_data_fifo_fft/s_axis_aclk] [get_bd_pins axis_data_fifo_raw/s_axis_aclk] [get_bd_pins ila_1/clk] [get_bd_pins max2769_interface_0/G_CLKOUT]
  connect_bd_net -net G_I0_1 [get_bd_pins G_I0] [get_bd_pins ila_1/probe4] [get_bd_pins max2769_interface_0/G_I0]
  ...
  connect_bd_net -net IQ2Stream_enable_Dout [get_bd_pins IQ2Stream_enable/Dout] [get_bd_pins IQ2stream_fft/enable_in] [get_bd_pins IQ2stream_raw/enable_in]
  connect_bd_net -net IQ2stream_fft_sample_no [get_bd_pins IQ2stream_fft/sample_no] [get_bd_pins ila_1/probe1]
  connect_bd_net -net IQ2stream_fft_tlast_out [get_bd_pins IQ2stream_fft/tlast_out] [get_bd_pins ila_1/probe0]
  ...
  connect_bd_net -net axis_data_fifo_fft_axis_rd_data_count [get_bd_pins axis_data_fifo_fft/axis_rd_data_count] [get_bd_pins ila_2/probe1]
  connect_bd_net -net axis_data_fifo_fft_axis_wr_data_count [get_bd_pins axis_data_fifo_fft/axis_wr_data_count] [get_bd_pins ila_2/probe0]
  connect_bd_net -net axis_data_fifo_fft_prog_empty [get_bd_pins axis_data_fifo_fft/prog_empty] [get_bd_pins ila_2/probe2]
  connect_bd_net -net axis_data_fifo_fft_prog_full [get_bd_pins axis_data_fifo_fft/prog_full] [get_bd_pins ila_2/probe3]
  connect_bd_net -net fifo_reset_Dout [get_bd_pins axis_data_fifo_fft/s_axis_aresetn] [get_bd_pins axis_data_fifo_raw/s_axis_aresetn] [get_bd_pins not_0/Res]
  ...
  connect_bd_net -net max2769_interface_0_IQ_data [get_bd_pins IQ2stream_raw/IQ_sample_in] [get_bd_pins tx_stream_mux_0/out_stream]
  ...
  connect_bd_net -net max2769_interface_0_IQ_to_fft [get_bd_pins IQ2stream_fft/IQ_sample_in] [get_bd_pins ila_1/probe3] [get_bd_pins max2769_interface_0/IQ_to_fft]
  connect_bd_net -net max2769_interface_0_IQ_to_fft_valid [get_bd_pins IQ2stream_fft/valid_in] [get_bd_pins ila_1/probe2] [get_bd_pins max2769_interface_0/IQ_to_fft_valid]
  connect_bd_net -net max2769_interface_0_IQ_valid [get_bd_pins IQ2stream_raw/valid_in] [get_bd_pins max2769_interface_0/IQ_valid]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axis_data_fifo_fft/m_axis_aclk] [get_bd_pins axis_data_fifo_raw/m_axis_aclk] [get_bd_pins gps_ip_settings/s_axi_aclk] [get_bd_pins ila_0/clk] [get_bd_pins ila_2/clk]
  ...
  connect_bd_net -net samples_per_blk_Dout [get_bd_pins IQ2stream_fft/samplesPerBlock] [get_bd_pins IQ2stream_raw/samplesPerBlock] [get_bd_pins samples_per_blk/Dout]
  ...
  connect_bd_net -net vcc_dout [get_bd_pins IQ2stream_fft/m00_axis_aresetn] [get_bd_pins IQ2stream_raw/m00_axis_aresetn] [get_bd_pins vcc/dout]
